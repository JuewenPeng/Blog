...
![image]({{site.baseurl}}/images/image-2022-07-02-14-15-05.png){:width="100%"}
<div class="figcap">Figure 5: Training and sampling algorithms</div>
...
Conducting interpolation in latent space, and then decoding the linearly interpolated latent into image space by the reverse process generates more plausible and smoothly varying results compared with direct image space interpolation.  
