...
For the forward process, larger $$t$$ leads to noisier $$x_t$$ with less information of original data. Starting from noisier $$x_t$$, the reverse process can synthesize more diverse images.
